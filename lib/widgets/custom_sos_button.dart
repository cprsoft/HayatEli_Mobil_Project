...
class _CustomSosButtonState extends ConsumerState<CustomSosButton>
  ...
  Future<void> _executeSosAction({required BuildContext context, required bool isForSelf}) async {
    ...
    if (isForSelf) {
      String locationText = "Bilinmiyor";
      String googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=${Uri.encodeComponent(locationText)}";
      String emergencyPhone = "112";
