...
- **API Entegrasyonları:** Nosy API (Eczane verileri), Google Cloud TTS
...
### 1. Depoyu Klonlayın
```bash
git clone https://github.com/kullanici_adiniz/hayat_eli_mobil_uygulamasi.git
...
---
**Not:** Bu proje bir bitirme çalışması kapsamında geliştirilmiştir. Gelecek fazlarda yapay zeka destekli ilkyardım asistanı entegrasyonu hedeflenmektedir.
